...
export const agents: Agent[] = [
  ...
  {
    id: "support-insight-scribe",
    name: "Support Insight Scribe",
    room: "support",
    functionLabel: "Customer Support",
    persona: "Chief Customer Officer",
    description:
      "Interaction summarization agent that turns support conversations into structured notes, resolution codes and voice-of-customer insight.",
    outcome: "Consistent case documentation and richer voice-of-customer signal.",
    roiCategory: "Productivity",
    risk: "Low-Medium",
    dataSensitivity: "High",
    approvedActions: "Summarize interactions, classify cases, surface trends",
    humanApproval: "Required before case closure",
    certification: "Certified",
    governance: "Certified",
    adoption: 73,
    usage: 76,
    roiScore: 80,
    maturity: "Scaling",
    pattern: "Azure AI Foundry + Fabric analytics",
    status: "Live",
    url: "https://insight-scribe-710.lovable.app",
  },
  {
