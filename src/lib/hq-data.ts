...
export const agents: Agent[] = [
  ...
  {
    id: "security-ops-copilot",
    name: "Security Operations Copilot",
    room: "security",
    functionLabel: "Corporate Security",
    persona: "Cybersecurity Leader",
    description:
      "AI security operations copilot that triages alerts, correlates threat signals, drafts incident response playbooks, and accelerates investigation workflows.",
    outcome: "Faster threat detection and shorter incident response cycles.",
    roiCategory: "Risk reduction",
    risk: "High",
    dataSensitivity: "Confidential",
    approvedActions: "Correlate alerts, draft response plans, enrich cases",
    ...
    roiScore: 80,
    maturity: "Piloting",
    pattern: "Sentinel + Defender + Azure OpenAI",
    status: "Ramping",
    url: "https://insight-scribe-710.lovable.app",
  },
  {
    id: "shield-sentinel",
    name: "Shield Sentinel Agentic Solution",
    room: "security",
    functionLabel: "Corporate Security",
    persona: "Chief Security Officer",
    description:
      "Autonomous security sentinel that monitors identity, endpoint, and network telemetry for anomalies, surfaces active risks, and recommends protective actions.",
    outcome: "Improved security posture and proactive breach prevention.",
    roiCategory: "Risk reduction",
    risk: "High",
    dataSensitivity: "Confidential",
    approvedActions: "Monitor telemetry, flag anomalies, recommend hardening",
    humanApproval: "Required for policy changes",
    certification: "Certified",
    governance: "Certified",
    adoption: 70,
    usage: 74,
    roiScore: 82,
    maturity: "Scaling",
    pattern: "Microsoft Defender + Entra + Fabric security lakehouse",
    status: "Live",
  ...
  },
  {
    ...
    persona: "Contact Center Leader",
    description:
      "AI agent-assist solution that listens to live customer conversations, surfaces relevant knowledge, recommends next-best-actions, and drafts responses.",
    outcome: "Higher first-contact resolution and lower average handle time.",
    roiCategory: "Productivity",
    risk: "Medium",
    dataSensitivity: "High",
    approvedActions: "Retrieve knowledge, suggest responses, summarize cases",
    humanApproval: "Agent confirms every customer-facing response",
    certification: "Certified",
    governance: "Certified",
    adoption: 82,
    usage: 86,
    roiScore: 86,
    maturity: "Scaling",
    pattern: "Copilot Studio + Dynamics Contact Center + Knowledge base",
    status: "Live",
    url: "https://assist-pro-genius.lovable.app",
  },
  {
    id: "support-insight",
    name: "Support Insight Scribe",
    room: "support",
    functionLabel: "Customer Support",
    persona: "Digital Support Leader",
    description:
      "Conversational intelligence agent that summarizes support interactions, extracts trends, identifies coaching opportunities, and improves self-service content.",
    outcome: "Better contact-center insights and continuous self-service improvement.",
    roiCategory: "Productivity",
    risk: "Medium",
    dataSensitivity: "High",
    approvedActions: "Summarize interactions, tag trends, propose knowledge articles",
    humanApproval: "Required before publishing knowledge updates",
    certification: "Production candidate",
    governance: "Production candidate",
    adoption: 68,
    usage: 71,
    roiScore: 77,
    maturity: "Piloting",
    pattern: "Azure AI Speech + Language + Fabric analytics",
    status: "Ramping",
    url: "https://insight-scribe-710.lovable.app",
  },
  {
    ...
    room: "support",
    functionLabel: "Customer Support",
    persona: "Field Service Leader",
    description:
      "Field and service intelligence agent that diagnoses customer network issues, recommends technician dispatch, and guides customers through self-healing steps.",
    outcome: "Fewer truck rolls and faster customer-impacting issue resolution.",
    roiCategory: "Cost reduction",
    risk: "Medium",
    dataSensitivity: "High",
    approvedActions: "Diagnose issues, recommend steps, suggest dispatch",
    humanApproval: "Required for technician dispatch",
    certification: "Certified",
    governance: "Certified",
    adoption: 75,
    usage: 78,
    roiScore: 83,
    maturity: "Scaling",
    pattern: "Azure AI Foundry + OSS/BSS telemetry + field-service knowledge",
    status: "Live",
