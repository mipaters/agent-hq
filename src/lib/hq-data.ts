...
export const agents: Agent[] = [
  ...
  },
  {
    ...
    persona: "SOC Leader",
    description:
      "Investigation copilot that assembles evidence, drafts incident narratives, and produces analyst-ready summaries for security reviews.",
    outcome: "Faster investigations with consistent, audit-ready incident documentation.",
    roiCategory: "Productivity",
    risk: "Medium",
    dataSensitivity: "Confidential",
    approvedActions: "Summarize incidents, assemble evidence, draft reports",
    humanApproval: "Required before external reporting",
    certification: "Certified",
    governance: "Certified",
    adoption: 71,
    usage: 74,
  ...
  {
    id: "shield-sentinel",
    name: "Shield AI Sentinels",
    room: "security",
    functionLabel: "Corporate Security",
    persona: "CISO",
    description:
      "Multi-agent security sentinel network that monitors threat signals, correlates alerts, and recommends containment actions across the enterprise estate.",
    outcome: "Lower dwell time and earlier containment of enterprise threats.",
    roiCategory: "Risk reduction",
    risk: "High",
    dataSensitivity: "Confidential",
    approvedActions: "Monitor threat signals, correlate alerts, recommend containment",
    humanApproval: "Required for containment actions",
    certification: "Production candidate",
    governance: "Production candidate",
    adoption: 66,
    usage: 70,
  ...
  },
  {
    ...
    name: "Assist Pro Genius",
    room: "support",
    functionLabel: "Customer Support",
    persona: "Care Operations Leader",
    description:
      "Real-time care agent assist that surfaces account context, suggested responses and next-best actions during customer interactions.",
    outcome: "Shorter handle times and higher first-contact resolution in the contact center.",
    roiCategory: "Productivity",
    risk: "Medium",
    dataSensitivity: "High",
    approvedActions: "Retrieve customer context, suggest responses and next-best actions",
    humanApproval: "Care agent in the loop",
    certification: "Certified",
    governance: "Certified",
    adoption: 78,
    usage: 82,
  ...
  },
  {
    ...
    name: "Billing Inquiry AI",
    room: "support",
    functionLabel: "Customer Support",
    persona: "Billing Operations Leader",
    description:
      "AI agent that resolves billing questions, explains charges, identifies discrepancies, and guides customers through payment options and plan changes.",
    outcome: "Faster billing resolution and fewer billing-related escalations.",
    roiCategory: "Cost reduction",
    risk: "Medium",
    dataSensitivity: "High",
    approvedActions: "Retrieve account charges, explain bills, identify discrepancies, guide payment options",
    humanApproval: "Required for payment disputes and plan changes",
    certification: "Certified",
    governance: "Certified",
    adoption: 75,
    usage: 78,
  ...
  },
  {
    ...
    name: "Network Genius AI",
    room: "support",
    functionLabel: "Customer Support",
    persona: "Digital Support Leader",
    description:
      "Technical support agent that diagnoses connectivity and device issues for customers, guiding care teams through resolution steps.",
    outcome: "Higher technical resolution accuracy and fewer avoidable truck rolls.",
    roiCategory: "Cost reduction",
    risk: "Medium",
    dataSensitivity: "High",
    approvedActions: "Run diagnostics, recommend resolution steps, schedule follow-up",
    humanApproval: "Required for dispatch",
    certification: "Production candidate",
    governance: "Production candidate",
    adoption: 68,
    usage: 71,
...
export const roiRows = [
  ...
  { room: "Corporate Security", lever: "Threat detection and investigation productivity", value: 18, owner: "CISO" },
  { room: "Customer Support", lever: "Handle time, resolution quality and deflection", value: 26, owner: "Care Operations Leader" },
  {
...
export const customerDemos: CustomerDemo[] = [
  {
    ...
    demos: [
      {
        id: "rogers-website",
        name: "Rogers Agentic AI Website Demo",
        category: "Website",
        description:
          "Public-facing website demo showcasing Rogers' agentic AI strategy, executive narrative, and interactive agent experiences.",
        outcome: "Executive-ready storytelling and lead engagement for Rogers agentic AI.",
        url: "https://rogerswebsite.patersonindustrydemos.com",
        tone: "red",
      },
      {
        id: "rogers-mobile-app",
        name: "Rogers Agentic AI Mobile App Demo",
        category: "Mobile App",
        description:
          "Mobile app version of the Rogers Agentic AI demo, optimized for on-the-go executive reviews and customer-facing walkthroughs.",
        outcome: "Consistent agentic AI narrative across desktop and mobile channels.",
        url: "https://rogersapp.patersonindustrydemos.com",
        tone: "red",
      },
      {
        id: "rogers-mlse",
      ...
      {
        id: "rogers-churn",
        name: "Rogers Churn Reduction Solution",
        category: "Consumer",
        description:
